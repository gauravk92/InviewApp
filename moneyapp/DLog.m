...
+ (NSString*)cTypeEncoding:(void*)value {
    ...
    if (strcmp(encoding, [GLog cTypeString:_C_INT])) {
        return @"int";
    } else if (strcmp(encoding, @encode(int *))) {
        return @"int*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_FLT])) {
        return @"float";
    } else if (strcmp(encoding, @encode(float *))) {
        return @"float*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_CHR])) {
        return @"char";
    } else if (strcmp(encoding, @encode(char *))) {
        return @"char*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_BOOL])) {
        return @"BOOL";
    } else if (strcmp(encoding, @encode(BOOL *))) {
        return @"BOOL*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_DBL])) {
        return @"double";
    } else if (strcmp(encoding, @encode(double *))) {
        return @"double*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_VOID])) {
        return @"void";
    } else if (strcmp(encoding, @encode(void *))) {
        return @"void*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_SHT])) {
        return @"short";
    } else if (strcmp(encoding, @encode(short *))) {
        return @"short*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_LNG])) {
        return @"long";
    } else if (strcmp(encoding, @encode(long *))) {
        return @"long*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_LNG_LNG])) {
        return @"long long";
    } else if (strcmp(encoding, @encode(long long *))) {
        return @"long long*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_UCHR])) {
        return @"unsigned char";
    } else if (strcmp(encoding, @encode(unsigned char *))) {
        return @"unsigned char*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_UINT])) {
        return @"unsigned int";
    } else if (strcmp(encoding, @encode(unsigned int *))) {
        return @"unsigned int*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_USHT])) {
        return @"unsigned short";
    } else if (strcmp(encoding, @encode(unsigned short *))) {
        return @"unsigned short*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_ULNG])) {
        return @"unsigned long";
    } else if (strcmp(encoding, @encode(unsigned long *))) {
        return @"unsigned long*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_ULNG_LNG])) {
        return @"unsigned long long";
    } else if (strcmp(encoding, @encode(unsigned long long *))) {
        return @"unsigned long long*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_CLASS])) {
        return @"Class";
    } else if (strcmp(encoding, [GLog cTypeString:_C_SEL])) {
        return @"SEL";
    } else if (strcmp(encoding, [GLog cTypeString:_C_ID])) {
        return @"id";
    } else if (strcmp(encoding, @encode(typeof(id*)))) {
        return @"id*";
    } else if (strcmp(encoding, "r^@")) {
        return @"&id";
    } else if (strcmp(encoding, [GLog cTypeString:_C_BFLD])) {
        return @"C-BitField-Type=b";
    } else if (strcmp(encoding, [GLog cTypeString:_C_UNDEF])) {
        return @"undef";
    } else if (strcmp(encoding, [GLog cTypeString:_C_PTR])) {
        return @"C-Pointer-Type=^";
    } else if (strcmp(encoding, [GLog cTypeString:_C_CHARPTR])) {
        return @"C-CharPointer-Type=*";
    } else if (strcmp(encoding, [GLog cTypeString:_C_ATOM])) {
        return @"atom";
    } else if (strcmp(encoding, [GLog cTypeString:_C_VECTOR])) {
        return @"vector";
    } else if (strcmp(encoding, [GLog cTypeString:_C_CONST])) {
        return @"const";
