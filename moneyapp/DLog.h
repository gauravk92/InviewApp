...
#define DLogCATransform3d(val)      NSLog(@"%s:%s:%@;", PRE, #val, [GLog CATransform3D:val])
#define DLogUIGestureRecognizerState(val)   NSLog(@"%s:%s:%@;", PRE, #val, [GLog UIGestureRecognizerState:val])
